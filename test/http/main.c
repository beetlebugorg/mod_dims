...
extern const dims_test dims_tests_legacy_endpoints[];
extern const dims_test dims_tests_metrics[];
...
static const dims_test_group groups[] = {
    ...
    { "test_legacy_endpoints.c", dims_tests_legacy_endpoints },
    { "test_metrics.c", dims_tests_metrics },
